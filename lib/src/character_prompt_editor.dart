...
class _CharacterPromptEditorState extends State<CharacterPromptEditor> {
                              ...
                              children: [
                                _TavernMetaChip(
                                  icon: widget.world
                                      ...
                                      : Icons.badge_rounded,
                                  label: isDefault
                                      ? language.text('默认', 'Default', 'デフォルト')
                                      : language.text('自定义', 'Custom', 'カスタム'),
                                ),
                                _TavernMetaChip(
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: Text(
                        language.text('恢复默认', 'Restore defaults', 'デフォルトに戻す'),
                      ),
                    ),
                  ),
                  ...
                  Expanded(
                    child: FilledButton.icon(
                      ...
                      label: Text(language.text('保存', 'Save', '保存')),
                    ),
                  ),
                ],
              ),
  ...
  void _save(BuildContext context) {
    ...
    if (widget.world) {
      widget.controller.setWorldSetting(_text.text);
    } else {
      widget.controller.setCharacterPersona(_text.text);
    }
